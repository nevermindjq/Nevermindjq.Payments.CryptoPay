...
public sealed class GetTransfersRequest : ParameterlessRequest<Transfers> {
    ...
    public GetTransfersRequest(IEnumerable<string> asset = default, IEnumerable<string> transferIds = default, string spendId = null, int offset = 0, int count = 100) : base("getTransfers") {
		Asset = asset;
